...
/**
 * Draws single dots for the image
 * 
 * @param x - The horizontal position within the image
 * @parm y - The vertical position within the image
 * 
 */
...
/**
 * Draws horizontal lines for the image
 * 
 * @param x - The horizontal position within the image
 * @parm y - The vertical position within the image
 * 
...
/**
 * Draws vertical lines for the image
 * 
 * @param x - The horizontal position within the image
 * @parm y - The vertical position within the image
 * 
 ...
 * "off" pixel with.
 */
function outputImage(onChar: string = "X", offChar: string = ' ') {
  let text = "";
